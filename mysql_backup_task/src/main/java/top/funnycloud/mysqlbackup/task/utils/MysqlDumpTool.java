package top.funnycloud.mysqlbackup.task.utils;

import java.io.File;
import java.io.IOException;

public class MysqlDumpTool {
    public static void exportDatabaseTool(String dumpPath,String hostIP,String port, String userName, String password, String savePath,String fileName, String databaseName) {
        ...
        stringBuilder.append(dumpPath)/*.append(" --opt")*/.append(" -h").append(hostIP).append(" -P").append(port);
