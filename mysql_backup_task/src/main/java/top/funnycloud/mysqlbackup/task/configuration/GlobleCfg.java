...
import top.funnycloud.mysqlbackup.task.utils.DBObjectID;
import top.funnycloud.mysqlbackup.task.utils.FileHelper;
...
public class GlobleCfg {
    ...
    @Value("${mysqlback.dataPath}")
     String dataPath;
    @Value("${mysqlback.dbEnKey}")
     String  dbEnKey;
    @Value("${mysqlback.savepath}")
    String  savepath;
    @Value("${mysqlback.dumppath}")
    String  dumppath;
