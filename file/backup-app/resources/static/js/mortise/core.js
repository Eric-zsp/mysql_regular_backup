...
//根据用户ID数组获取用户信息
mortise_core.getUsers= function (uids,callback){
...
//根据用户ID数组获取用户信息
mortise_core. getCompanyUsers=function(CompanyCD,callback){
...
mortise_core. getMyCompanys=function(callback) {
...
mortise_core. getMyProjects=function(companycd,callback) {
...
mortise_core. getMyRoomsByProjectCD=function(companycd,projectcd,callback) {
...
mortise_core. timeStampToFormatString=function(second_time) {
...
mortise_core.parseTime=function(strdate){
...
//region 账单支付状态
mortise_core.bill={}
mortise_core.bill.ChargeStatus_operat={valueNames:[
        {value: 0, name: '待支付'},
        {value: 1, name: '已支付'},
        {value: 2, name: '订单处理中'},
        {value: 3, name: '已完成'}],getName:function (value) {
        var result = '';
        $(mortise_core.bill.ChargeStatus_operat.valueNames).each(function (i, vn) {
            if (vn.value == value) {
                result = vn.name;
                return false;
            }
...
mortise_core.bill.ChargePayType_operat={valueNames:[
        {value: 1, name: '微信支付'},
        {value: 2, name: '支付宝支付'},
        {value: 3, name: '后台充值'},
        {value: 4, name: '系统赠送'},
        ...
        var result = '';
        $(mortise_core.bill.ChargePayType_operat.valueNames).each(function (i, vn) {
            if (vn.value == value) {
                result = vn.name;
                return false;
            }
