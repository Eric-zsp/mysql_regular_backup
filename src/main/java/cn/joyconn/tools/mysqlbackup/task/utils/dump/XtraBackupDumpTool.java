...
public class XtraBackupDumpTool {
    public static void backup( String hostIP,String port, String userName, String password, String savePath,String fileName, String databaseName,List<String> tables) {
        ...
        stringBuilder.append("innobackupex ")/*.append(" --opt")*/.append(" -h").append(hostIP).append(" -P").append(port);
